...
var App = function (_Component) {
  ...
  function App() {
    ...
    }, _this.handleChange = function (targetId, e) {
      // console.log(this.state);
      // console.log(e.target.value);
      var name = _this.state.name;

      if (targetId === _this.state.clickName) {
        _this.setState(babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, name, babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, e.target.value, e.target.value)));
      }
...
//# sourceMappingURL=main.54e3defd6276db4a8309.hot-update.js.map