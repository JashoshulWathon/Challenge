...
function Home() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
    ...
    post.data.map(function (post) {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Post, { key: post.id, list: post, __source: {
          fileName: _jsxFileName,
          lineNumber: 34
        }
      });
...
//# sourceMappingURL=main.bdf38cc936dac3791b36.hot-update.js.map