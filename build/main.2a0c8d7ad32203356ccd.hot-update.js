...
function App() {
  ...
  var addTodo = function addTodo(text) {
    ...
    setTodos(newTodos);
    (_console = console).log.apply(_console, babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(todos).concat([{ text: text }, { text: text }]));
    (_console2 = console).log.apply(_console2, babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(todos).concat([{ text: text }, { text: text }]));
  };
...
//# sourceMappingURL=main.2a0c8d7ad32203356ccd.hot-update.js.map