...
var App = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5___default()(this, (_ref = App.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_2___default()(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState(babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, name, babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, e.target.id, e.target.value)));
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(
        ...
        name.map(function (user) {
          return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(
            ...
            _this3.state.isEdit && _this3.state.clickName === user.id ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement('input', { id: user.id, style: { display: 'inline', marginRight: 10 },
...
//# sourceMappingURL=main.bd4bb25f99b68a6ff52b.hot-update.js.map