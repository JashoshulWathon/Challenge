...
var App = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4___default()(this, (_ref = App.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_1___default()(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var newVal = [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(user), [{ name: val }]);
      _this.setState({ name: newVal });
      ...
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(
        ...
        name.map(function (user) {
          return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(
            ...
            _this3.state.isEdit && _this3.state.clickName === user.id ? react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement('input', { style: { display: 'inline', marginRight: 10 }, onFocus: _this3.handlefocus, autoFocus: true, onChange: function onChange(e) {
...
//# sourceMappingURL=main.42b9e3918473de848978.hot-update.js.map