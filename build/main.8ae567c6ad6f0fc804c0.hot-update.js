...
var App = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5___default()(this, (_ref = App.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_2___default()(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var userId = user.id;
      _this.setState({
        user: babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, _this.state.user, babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, e.target.userId, e.target.value))
      });
...
//# sourceMappingURL=main.8ae567c6ad6f0fc804c0.hot-update.js.map