...
var App = function (_Component) {
  babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6___default()(App, _Component);
  ...
  function App() {
    ...
    babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default()(this, App);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5___default()(this, (_ref = App.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_2___default()(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      name: [],
      isEdit: false,
      clickName: null
    ...
    }, _this.handleChange = function (user, e) {
      // console.log(this.state);
      // const val = e.target.value;
      // const { name } = this.state;
      // if (targetId === this.state.clickName) {
      // }
      _this.setState({
        user: babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, _this.state.user, babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, e.target.user.id, e.target.value))
      });
  ...
  babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(App, [{
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(
        ...
        name.map(function (user) {
          return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(
            ...
            _this3.state.isEdit && _this3.state.clickName === user.id ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement('input', { style: { display: 'inline', marginRight: 10 }, onFocus: _this3.handlefocus, autoFocus: true, onChange: function onChange(e) {
                return _this3.handleChange(user, e);
            ...
            _this3.state.isEdit && _this3.state.clickName === user.id ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(
              'button',
...
//# sourceMappingURL=main.9a6e914b62611e11fb64.hot-update.js.map