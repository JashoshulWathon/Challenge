...
/* harmony import */ var babel_runtime_core_js_object_values__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babel-runtime/core-js/object/values */ "babel-runtime/core-js/object/values");
...
var App = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4___default()(this, (_ref = App.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_1___default()(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var arr = babel_runtime_core_js_object_values__WEBPACK_IMPORTED_MODULE_0___default()(user.id);
      console.log(user.id);
      console.log(arr);
      console.log(e.target.id);
      // console.log(this.state);
      if (user.id === e.target.id) {
        console.log("sammmmmmaaaaaa");
      } else {
        console.log("dieee");
      }
      ...
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(
        ...
        name.map(function (user) {
          return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(
            ...
            !_this3.state.isEdit ? react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(
              'h1',
              {
                __source: {
                  fileName: _jsxFileName,
              ...
              user.name
            ) : react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement('input', { onFocus: _this3.handlefocus, autoFocus: true, onChange: function onChange(e) {
...
//# sourceMappingURL=main.3d9bf6d3276513bdd232.hot-update.js.map